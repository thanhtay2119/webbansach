...
<asp:Content ID="Content2" ContentPlaceHolderID="cpMainContent" Runat="Server">
    <asp:ListView ID="ListView1" runat="server" DataKeyNames="Id" DataSourceID="EntityDataSource1" InsertItemPosition="LastItem" ItemType="ngocminhtranModel.Picture" OnItemInserting="ListView1_ItemInserting">
    ...
    <asp:EntityDataSource ID="EntityDataSource1" runat="server" ConnectionString="name=ngocminhtranEntities" DefaultContainerName="ngocminhtranEntities" EnableDelete="True" EnableFlattening="False" EnableInsert="True" EntitySetName="Pictures" EntityTypeFilter="" Select="" Where="it.PhotoAlbum.Id = @photoAlbumId" OnInserting="EntityDataSource1_Inserting">
        <WhereParameters>
            <asp:QueryStringParameter DefaultValue="" Name="PhotoAlbumId" QueryStringField="PhotoAlbumId" Type="Int32" />
        </WhereParameters>
